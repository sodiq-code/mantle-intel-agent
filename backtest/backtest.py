...
def _write_results_md(metrics, tp_list, fp_list, fn_list, findings, blocks):
    ...
    lines = [
        ...
        "|--------|-----------|-------------|",
        "| Z-Score | 3.5σ (v2: raised from 3.0σ) | Applied to tx_count and total_value_mnt time series |",
        "| Isolation Forest | contamination=0.02, n=150 (v2: tuned) | Multi-dimensional outlier detection |",
